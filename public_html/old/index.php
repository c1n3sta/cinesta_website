...
<meta name="yandex-verification" content="b212a174417fd138" />
<meta name="keywords" content="видео, съемка, спинфото, spinfoto,spin-foto,spin foto, spin foto, спин фото, спин-фото, 3d с вращением, видео 360, фото 360, фотография 360,предметная съемка, предметное видео, обзоры, реклама">
 <meta name="description" content="Создание фото и видео материалов для бизнеса">
<title>CINESTA</title>
...
<div class="b-popup" id="popup1">
    <div class="b-popup-content" id="popup" style="display:none">
...
<!--rightMenu-->
<div style="position:absolute; width:61px;z-index:1001" id="rightMenu">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="padding-bottom:40px"><a href="https://vk.com/cinesta" target="_parent"><img src="img/vk.png" style="border:none"></a></td>
  </tr>
  <tr>
    <td><a href="https://www.instagram.com/cinesta.me/" target="_parent"><img src="img/insta.png" style="border:none"></a></td>
  </tr>
</table>
</div>
<!--header -->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:auto;min-width:600px">
  <tr>
  	<td width="5%">&nbsp;</td>
    <td width="30%" class="logoCell"><a href="javascript:GoToNextSlide(0,1)"><span class="logoText" style="float:left; width:100%; text-align:center; font-weight:bold; color:#FFF;line-height: initial;"><img src="img/logo.png" alt="cinesta" title="cinesta" width="342" height="58"></span></a></td>
    <td width="35%">&nbsp;</td>
    ...
    <div class="ankers" style="width:100%;margin:auto;float:left;    line-height: 33px;">
		...
		<a href="javascript:GoToNextSlide(0,4)" id="price">ЦЕНЫ</a>
	</div>
    </td>
  </tr>
</table>
...
<div style="margin-bottom:50px;">
	<h2 id="H2_Main">профессионально снимаем<br>промо-видео в инстаграм</h2>
</div>
...
<div>
	<h2 id="h2Works">НАШИ РАБОТЫ</h2>
   	<script src="filmrol.js"></script>
    <div id="film_roll">
  		<div>
    		<video controls="controls" class="OneVideo" preload="auto" loop>
	<source src="vidosy/01BlockFIN_1_1.mp4" type="video/mp4" />
	<object type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" width="640" height="360">
		<param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" />
		<param name="allowFullScreen" value="true" />
		<param name="wmode" value="transparent" />
		<param name="flashVars" value="config={'playlist':[{'url':'vidosy/01BlockFIN_1_1.mp4','autoPlay':false}]}" />
	</object>
</video>
  		</div>
  		<div>
    		<video controls="controls" class="OneVideo" preload="auto" loop>
	<source src="vidosy/01Otdel_FIN_1_1.mp4" type="video/mp4" />
	<object type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" width="640" height="360">
		<param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" />
		<param name="allowFullScreen" value="true" />
		<param name="wmode" value="transparent" />
		<param name="flashVars" value="config={'playlist':[{'url':'vidosy/01Otdel_FIN_1_1.mp4','autoPlay':false}]}" />
	</object>
</video>
  		</div>
        <div>
    		<video controls="controls" class="OneVideo" preload="none" loop>
	<source src="vidosy/01SEVER_fin_1_1.mp4" type="video/mp4" />
	<object type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" width="640" height="360">
		<param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" />
		<param name="allowFullScreen" value="true" />
		<param name="wmode" value="transparent" />
		<param name="flashVars" value="config={'playlist':[{'url':'vidosy/01SEVER_fin_1_1.mp4','autoPlay':false}]}" />
        ...
        <div>
    		<video controls="controls" class="OneVideo" preload="none" loop>
	<source src="vidosy/01t_FINAL_1.mp4" type="video/mp4" />
	<object type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" width="640" height="360">
		<param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" />
		<param name="allowFullScreen" value="true" />
		<param name="wmode" value="transparent" />
		<param name="flashVars" value="config={'playlist':[{'url':'vidosy/01t_FINAL_1.mp4','autoPlay':false}]}" />
		<span title="No video playback capabilities, please download the video below">backM.mp4</span>
	</object>
</video>
  		</div>
                <div>
    		<video controls="controls" class="OneVideo" preload="none" loop>
	<source src="vidosy/02Block_fin_1_1.mp4" type="video/mp4" />
	<object type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" width="640" height="360">
		<param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" />
		<param name="allowFullScreen" value="true" />
		<param name="wmode" value="transparent" />
		<param name="flashVars" value="config={'playlist':[{'url':'vidosy/02Block_fin_1_1.mp4','autoPlay':false}]}" />
		<span title="No video playback capabilities, please download the video below">backM.mp4</span>
	</object>
</video>
  		</div>
                <div>
    		<video controls="controls" class="OneVideo" preload="none" loop>
	<source src="vidosy/02SEVER_finFINAL_1_1.mp4" type="video/mp4" />
	<object type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" width="640" height="360">
		<param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" />
		<param name="allowFullScreen" value="true" />
		<param name="wmode" value="transparent" />
		<param name="flashVars" value="config={'playlist':[{'url':'vidosy/02SEVER_finFINAL_1_1.mp4','autoPlay':false}]}" />
		<span title="No video playback capabilities, please download the video below">backM.mp4</span>
	</object>
</video>
  		</div>
                <div>
    		<video controls="controls" class="OneVideo" preload="none" loop>
	<source src="vidosy/03Block_fin_1_1_1.mp4" type="video/mp4" />
	<object type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" width="640" height="360">
		<param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" />
		<param name="allowFullScreen" value="true" />
		<param name="wmode" value="transparent" />
		<param name="flashVars" value="config={'playlist':[{'url':'vidosy/03Block_fin_1_1_1.mp4','autoPlay':false}]}" />
		<span title="No video playback capabilities, please download the video below">backM.mp4</span>
	</object>
</video>
  		</div>
                <div>
    		<video controls="controls" class="OneVideo" preload="none" loop>
	<source src="vidosy/03SEVER_fin_1_1.mp4" type="video/mp4" />
	<object type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" width="640" height="360">
		<param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf" />
		<param name="allowFullScreen" value="true" />
		<param name="wmode" value="transparent" />
		<param name="flashVars" value="config={'playlist':[{'url':'vidosy/03SEVER_fin_1_1.mp4','autoPlay':false}]}" />
		<span title="No video playback capabilities, please download the video below">backM.mp4</span>
	</object>
</video>
  		</div>
...
function dopPlusPanel(){
	...
	if(dopPlusPanelVisible){
		 ...
		 $('#slide3').css('min-height',380+268);
		 $('#slide3').css('height',380+268);
	}
	else {
		$('#morePlus').css('display','none');
		$('#slide3').css('min-height',380);
	    $('#slide3').css('height',380);
	}
...
<div style="height:300px">
  ...
  <tr>
    ...
    <div class="tarif">
        ...
        <span style="font-size:32pt;">7000₽</span><br>
    ...
    <div class="tarif">
        ...
        <span style="font-size:32pt;">14000₽</span><br>
    ...
    <div class="tarif">
        ...
        <span style="font-size:32pt;">31000₽</span><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="center" valign="middle" width="33%"><a href="https://www.instagram.com/cinesta.me/" target="_parent"><img src="img/insta.png" style="border:none"></a></td>
    <td align="center" valign="middle" width="33%"><a href="https://vk.com/cinesta" target="_parent"><img src="img/vk.png" style="border:none"></a></td>
  </tr>
</table>
</div>
</div>
...
function MakeSize(){
	showVidos();
	var vidiHeight=$('#slide2').height()-$('#h2Works').height()-50-10;
	
	//$('.OneVideo').height(vidiHeight);
	//console.log($('.OneVideo').height());
	$('.OneVideo').width($(window).width()/2);	
	$('.OneVideo').height($('.OneVideo').width()/1.777771521873768);
	$('#film_roll').height($('.OneVideo').height());
	...
	var h2Main=$(window).width()/20;
	if(h2Main<10) h2Main=10;
	if(h2Main>50) h2Main=50;
	$('#H2_Main').css('font-size',h2Main+'px');
	$("#fuzz").css("height", $(window).height());
	$("#rightMenu").css("top",$('.topMenu').height()+100+'px');
	$("#rightMenu").css("left",$("#price").offset().left+$("#price").width()/2 -$("#rightMenu").width()/2+'px');
	...
	$('#slide2').height($('#slide2Center').height()+50);
}
if($(window).height()>200){
		MakeSize();
	}
