/*! threesixty-slider 2013-11-26 verison 1.0.7 */
...
! function(a) {
    ...
    a.ThreeSixty = function(b, c) {
        ...
        e.$el = a(b), e.el = b, e.$el.data("ThreeSixty", e), e.init = function() {
            ...
            }).css(d.styles), d.responsive && e.$el.css({
                width: "100%"
            ...
            var b, c, g, h;
            b = document.createElement("li"), h = d.zeroBased ? 0 : 1, c = d.domain + d.imagePath + d.filePrefix + e.zeroPad(d.loadedImages + h) + d.ext + (e.browser.isIE() ? "?" + (new Date).getTime() : ""), g = a("<img>").attr("src", c).addClass("previous-image").appendTo(b), f.push(g), e.$el.find(d.imgList).append(b), a(g).load(function() {
                e.imageLoaded()
            })
            ...
            e.$el.find(".txtC").fadeIn(), e.$el.find(d.imgList).fadeIn(), e.ready = !0, d.ready = !0, e.initEvents(), e.refresh(), e.initPlugins()
            ...
            var a, b;
            return d.disableWrap ? (a = Math.min(d.currentFrame, d.totalFrames - (d.zeroBased ? 1 : 0)), b = Math.min(d.endFrame, d.totalFrames - (d.zeroBased ? 1 : 0)), a = Math.max(a, d.zeroBased ? 0 : 1), b = Math.max(b, d.zeroBased ? 0 : 1), d.currentFrame = a, d.endFrame = b) : (a = Math.ceil(d.currentFrame % d.totalFrames), 0 > a && (a += d.totalFrames - 1)), a
