...
$Page->form[]=new textType('name','Название',true);
$Page->form[]=new UrlType('url','Url','name',true);
$Page->form[]=new textEditorType('descriptions','Описание сверху');
$Page->form[]=new imgType('pathTop','Фото в описании сверху',398*2,288*2, $Page->table,false, array('pent'=>false,'border'=>false));
$Page->form[]=new textEditorType('text','Основная статья');
$Page->form[]=new imgType('path','Фото в навигации jpg,png ',278,323, $Page->table,true, array('pent'=>true,'border'=>false));
$Page->form[]=new rateType('rate','Рейтинг');
...
if(isset($_GET['add'])){
	...
	foreach ($Page->form as $formi) {
		$value='';
		//if($formi->type=='url') $value=$_SERVER["HTTP_REFERER"];
