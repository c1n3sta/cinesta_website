...
$Page->form[]=new checkType('show_menu','Показывать в меню');
$Page->form[]=new textType('name','Название',true);
$Page->form[]=new textType('url','Url',true);
$Page->form[]=new textEditorType('description','Описание');
...
if(isset($_GET['add'])){
	...
	$values['url']=rus_to_eng($values['name']);
...
else if(isset($_POST['edit']))
{
	...
	if(empty($values['url'])) $values['url']=rus_to_eng($values['name']);
